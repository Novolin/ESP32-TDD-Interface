...
I got a wicked deal on an Ultratec Miniprint a while ago, and I've been wanting to do something useful with it. With my Homebrew Computer slowly taking shape, I realized that the W65C51 serial adapter has support for Baudot encoding, meaning all I would need is a way to decode the audio, and then I can realize my dreams of having a beepyboopy keyboard system for a computer interface. 
...
If you want to follow along, take a peek at the [github page](https://github.com/Novolin/ESP32-TDD-Interface), which will also have drafts of my blog posts, since sometimes I'll be writing stuff on a different computer thanks to the cloud IDE stuff github can do!